...
- (id)init {
	if ((self = [super init])) {
        ...
        if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) {
            border = [CCSprite spriteWithFile:@"border.png" rect: CGRectMake(0, 0, 1024, 128)];
        }
        else {
        ...
        if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) {
            scoreRight.position = ccp(994, 54);
        }
        else {
        ...
        if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) {
            livesLeft.view.position = ccp(320, 52);
        }
        else {
        ...
        if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) {
            livesRight.view.position = ccp(704, 52);
        }
        else {
        ...
        if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) {
            restartButton.position = ccp(512, 60);
        }
        else {
